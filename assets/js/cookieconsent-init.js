    ...
    languages: {
        'en': {
            consent_modal: {
                ...
                description: 'Site-ul nostru <a href="https://showchat.eu.org" target="_blank class="cc-link">showchat.eu.org</a> folosește cookie-uri esențiale pentru a asigura funcționarea corectă și cookie-uri de urmărire pentru a înțelege modul în care interacționați cu acesta. Acesta din urmă va fi stabilit numai după acord. <a href="https://showchat.eu.org/politica-de-confidentialitate" class="cc-link">Politica de confidențialitate</a>',
                primary_btn: {
                ...
                blocks: [
                    {
                        ...
                        description: SHOWCHAT_POLITICA + ' <a href="https://showchat.eu.org/politica-cookies" class="cc-link">politica noastră cookie​.</a>' + "<br>" + SHOWCHAT_IMPORTANT
                    }, 
					...
					
					{
						...
						description: SHOWCHAT_NECESAR + "<br><br>" + SHOWCHAT_GEO + "<br>" + SHOWCHAT_GEOLOCATE, 
                        toggle: {
                            value: 'necessary',
                            enabled: true,
